...
<div class="w-100 position-relative">
    ...
    <?php endif; ?>
    <input type="number" placeholder="<?= $form_field_placeholder ?>" class="form-control form-control-sm border-0 border-bottom border-dark rounded-0 shadow-none" name="<?= $enc_field_name ?>" <?= $required ?>>
</div> 
...
document.addEventListener("DOMContentLoaded", function () {
	...
	const link = document.getElementById("sample-receipt-link");
	const previewSamplePhoto = document.getElementById("sample-receipt-preview");

	link.addEventListener("mouseenter", function (e) {
		previewSamplePhoto.style.display = "block";
		const rect = link.getBoundingClientRect();
		previewSamplePhoto.style.top = rect.bottom + window.scrollY + 8 + "px";
		previewSamplePhoto.style.left = rect.left + window.scrollX + "px";
	});

	link.addEventListener("mouseleave", function () {
		previewSamplePhoto.style.display = "none";
	});

	previewSamplePhoto.addEventListener("mouseenter", function () {
		previewSamplePhoto.style.display = "block";
	});

	previewSamplePhoto.addEventListener("mouseleave", function () {
		previewSamplePhoto.style.display = "none";
	});

	// For accessibility: show on focus, hide on blur

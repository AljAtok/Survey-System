$(document).ready(function () {
    ...
    //Group A Condition
    const gkkncncSelector = document.querySelector('#gkkncnc-selector');
    const groupAElements = document.querySelectorAll('.g-a');
    ...
    function checkRadioButton() {
        if (gkkncncSelector) {
            const defaultRadioButton3 = groupAElements[0].querySelector('input[type="radio"].default');

            const defaultRadioButton15 = groupAElements[1].querySelector('input[type="radio"].default');
            const defaultRadioButton16 = groupAElements[2].querySelector('input[type="radio"].default');
        
            if (gkkncncSelector.value === gkkncncSelector.options[0].value) {

                groupAElements[0].classList.add('d-none');
                groupAElements[2].classList.add('d-none');
                ...
                groupAElements[1].classList.remove('d-none');

                defaultRadioButton15.disabled = true;
                defaultRadioButton15.checked = false;
            }  else {

                groupAElements[0].classList.remove('d-none');
                groupAElements[2].classList.remove('d-none');
                ...
                groupAElements[1].classList.add('d-none');
    ...
    if (gkkncncSelector) {
        gkkncncSelector.addEventListener('change', function() {
            checkRadioButton();
        });
    }

    //Groub B Condition
    const bkbSelector = document.querySelector('#bkb-selector');
    const groupBElements = document.querySelectorAll('.g-b');
    
    $(document).ready(function () {
        groupBElements.forEach(function(element) {
    ...
    if (bkbSelector) {
        const defaultRadioButton26 = groupBElements[0].querySelector('input[type="radio"].default');
        const defaultRadioButton27 = groupBElements[1].querySelector('input[type="radio"].default');

        bkbSelector.addEventListener('change', function() {

            if(bkbSelector.value === bkbSelector.options[0].value){
                groupBElements[1].classList.add('d-none');
                groupBElements[0].classList.remove('d-none');
                ...
                groupBElements[0].classList.add('d-none');
                groupBElements[1].classList.remove('d-none');
